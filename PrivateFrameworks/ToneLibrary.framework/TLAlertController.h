...
@interface TLAlertController : NSObject
{
    ...
    NSMutableDictionary *_repeatedlyPlayingAlertsBeingStoppedBySoundIDs;
}

+ (id)sharedAlertController;
- (void)_repeatingSystemSoundDidFinishPlaying:(unsigned long)arg1;
- (void)_systemSoundDidFinishPlaying:(unsigned long)arg1;
- (BOOL)stopAllAlerts;
- (void)_didReachTimeoutForRepeatedlyPlayingSystemSoundStopping:(id)arg1;
- (void)_didReachTimeoutForSystemSound:(id)arg1;
- (id)_descriptionForAlertComponentsSuppressionFlags:(unsigned long)arg1;
- (unsigned long)_componentsSuppressionFlagsForAlert:(id)arg1;
- (unsigned long)_soundIDForAlert:(id)arg1;
- (BOOL)_stopAllAlerts;
@property(retain, nonatomic, setter=_setRepeatedlyPlayingAlertsBeingStoppedBySoundIDs:) NSMutableDictionary *_repeatedlyPlayingAlertsBeingStoppedBySoundIDs; // @synthesize _repeatedlyPlayingAlertsBeingStoppedBySoundIDs;
