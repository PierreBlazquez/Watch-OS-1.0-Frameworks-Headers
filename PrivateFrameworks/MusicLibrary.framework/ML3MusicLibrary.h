...
@class ML3AccountCacheDatabase, ML3Container, ML3DatabaseConnectionPool, ML3DatabaseMetadata, ML3LibraryNotificationManager, ML3SortMapSections, NSArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
...
- (unsigned long long)allAssetsTotalSize;
- (void)purgeCloudAssets;
- (unsigned long long)purchasesAndMusicTotalSize;
