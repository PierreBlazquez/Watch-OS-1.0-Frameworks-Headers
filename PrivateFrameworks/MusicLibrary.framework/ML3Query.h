...
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(BOOL)arg2 sectionProperty:(id)arg3 subCollectionProperty:(id)arg4 cancelBlock:(CDUnknownBlockType)arg5 usingBlock:(CDUnknownBlockType)arg6;
