...
@class CKAudioRecorder, CKComposition, CKConversation, CKInlineAudioReplyButtonController, CKJoystickController, CKJoystickGestureRecognizerButton, CKMessageEntryAudioHintView, CKMessageEntryContentView, CKMessageEntryRecordedAudioView, CKMessageEntryWaveformView, NSString, UIButton, UILabel, _UIBackdropView, _UITextFieldRoundedRectBackgroundViewNeue;
