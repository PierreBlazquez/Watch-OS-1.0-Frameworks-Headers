...
+ (id)ringsViewControllerConfiguredForOneRingOnGizmoOfType:(int)arg1;
+ (id)ringsViewControllerConfiguredForThreeRingsOnGizmo;
+ (id)_iconSpriteImage;
+ (id)_ringsViewControllerConfiguredForGizmoWithNumberOfRings:(int)arg1 ringType:(int)arg2;
