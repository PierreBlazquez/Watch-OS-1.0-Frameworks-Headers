...
+ (id)negationRegularExpressionForLanguage:(id)arg1;
+ (id)confirmationRegularExpressionForLanguage:(id)arg1;
...
@property(retain) NSArray *negations; // @synthesize negations=_negations;
@property(retain) NSArray *confirmations; // @synthesize confirmations=_confirmations;
