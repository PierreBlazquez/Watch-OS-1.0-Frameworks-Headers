...
+ (id)findCCNumberInImage:(struct vImage_Buffer)arg1;
+ (id)findCodeInImage:(struct vImage_Buffer)arg1 maxStage:(unsigned int)arg2 roi:(struct CGRect)arg3;
+ (id)findCCObjects:(id)arg1 InImage:(struct vImage_Buffer)arg2 nameRects:(id)arg3 dateRects:(id)arg4;
+ (id)findObjects:(id)arg1 inCorrectedImage:(struct vImage_Buffer)arg2 nameRects:(id)arg3 dateRects:(id)arg4;
+ (id)findObjects:(id)arg1 inPixelBuffer:(struct __CVBuffer *)arg2 withFixedCut:(struct CGRect)arg3 nameRects:(id)arg4 dateRects:(id)arg5;
