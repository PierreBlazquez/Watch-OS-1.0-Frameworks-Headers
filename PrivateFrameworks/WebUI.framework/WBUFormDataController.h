...
- (BOOL)_webView:(id)arg1 saveUsernameAndGeneratedPasswordFromForm:(id)arg2 inFrame:(id)arg3 confirmOverwritingCurrentPassword:(BOOL)arg4 submissionHandler:(CDUnknownBlockType)arg5;
- (BOOL)_webView:(id)arg1 saveUsernameAndGeneratedPasswordForURL:(id)arg2 fromForm:(id)arg3 inFrame:(id)arg4 username:(id)arg5 password:(id)arg6 confirmOverwritingCurrentPassword:(BOOL)arg7 submissionHandler:(CDUnknownBlockType)arg8;
- (void)_showPasswordPromptForWebView:(id)arg1 formType:(unsigned int)arg2 username:(id)arg3 isGeneratedPassword:(BOOL)arg4 host:(id)arg5 hasCredentialForCurrentHost:(BOOL)arg6 existingCredentialMatchesForCurrentHost:(id)arg7 otherSubdomainCredentialMatches:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
